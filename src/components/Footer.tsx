    ...
    <footer id="contacto" className="bg-black text-white py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p>Carrer Periodista Espinosa Echevarría, Bajo 1<br />03006 Alicante</p>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 mt-1 flex-shrink-0" />
                <div>
                  <p className="font-semibold">Martes - Domingo</p>
                  <p>9:00 - 16:00 | 20:00 - 00:00</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold mb-6">La Taberna de Lara</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              Donde la tradición y el sabor se encuentran. Nuestra pasión es ofrecer platos 
              auténticos y un ambiente acogedor que te hará sentir como en casa.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          ...
          <p className="text-gray-400 text-center text-sm">
            © {new Date().getFullYear()} La Taberna de Lara. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
